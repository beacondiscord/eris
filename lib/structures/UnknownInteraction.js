...
class UnknownInteraction extends Interaction {
  ...
  async createFollowup(content) {
    if (this.acknowledged === false) {
      throw new Error(
        'createFollowup cannot be used to acknowledge an interaction, please use acknowledge, createMessage, defer, deferUpdate, editParent, or pong first.'
      );
    }
  ...
  async editMessage(messageID, content) {
    if (this.acknowledged === false) {
      throw new Error(
        'editMessage cannot be used to acknowledge an interaction, please use acknowledge, createMessage, defer, deferUpdate, editParent, or pong first.'
      );
    }
    if (content !== undefined) {
      if (typeof content !== 'object' || content === null) {
  ...
  async editOriginalMessage(content) {
    if (this.acknowledged === false) {
      throw new Error(
        'editOriginalMessage cannot be used to acknowledge an interaction, please use acknowledge, createMessage, defer, deferUpdate, editParent, or pong first.'
      );
    }
    if (content !== undefined) {
      if (typeof content !== 'object' || content === null) {
