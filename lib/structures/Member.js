...
class Member extends Base {
  ...
  get avatarURL() {
    return this.avatar
      ? this.guild.shard.client._formatImage(Endpoints.GUILD_AVATAR(this.guild.id, this.id, this.avatar))
      : this.user.avatarURL;
  }
  ...
  get permission() {
    ...
    this.guild.shard.client.emit(
      'warn',
      '[DEPRECATED] Member#permission is deprecated. Use Member#permissions instead'
    );
